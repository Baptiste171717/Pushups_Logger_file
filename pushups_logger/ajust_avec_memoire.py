...
Exo = np.array(Exo)
Exo = np.column_stack(
    [Exo, np.zeros(Exo.shape[0])]
)  # composante mémoire afin de pas trop se répeter
# %%
e = 0
for i in range(0, 5):
    Exo[i][-1] = e
...
# e=1 semble optimal: on ne veut pas forcer
# l'exclusion des exercices si ils sont nécessaires
